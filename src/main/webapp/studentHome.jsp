...
<center><img src="mrulogo.png" width="150" height="150">
<img src="bcd.png" align="right"  width="150" height="150"></center>
...
body{
  ...
  background-image: linear-gradient(to right top, #0a0e28, #632c58, #c44e5d, #fc9740, #eef742);
...
<body>
  <table>
    ...
    <tbody>
      <tr>
        <td>IT38501</td>
        <td colspan="2">Distributed Computing</td>
        <td>Theory</td>
        <td>100</td>
        <td> 30 </td>
  ...
  <hr class="new1">
<center><h6>All Right Reserved @ MRU-2021</h6></center> 
  <hr class="new1">
</body>
<%}
else{
